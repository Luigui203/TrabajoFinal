...
from Controller.Mesero import Mesero  # Asegúrate de importar la clase Mesero
...
class OcuparMesa:
    def __init__(self, master, usuario):
        ...
        self.nueva_ventana.title("Ocupar Mesa")
        ...
        titulo = tk.Label(self.nueva_ventana, text="Ocupar Mesa", font=("Helvetica", 16))
        titulo.pack(pady=10)
        ...
        btn_guardar = tk.Button(frame_buttons, text="Guardar", command=self.ocupar_mesa)
    ...
    def ocupar_mesa(self):
        ...
        if self.mesero.ocupar_mesa(id_mesa):
            messagebox.showinfo("Éxito", "Mesa ocupada correctamente.")
            self.on_close()
        else:
